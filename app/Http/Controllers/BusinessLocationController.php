...
class BusinessLocationController extends Controller
{
    ...
    public function create()
    {
        ...
        $price_groups = \App\Utils\PerformanceUtil::getDropdownData('price_groups', $business_id);
        ...
        if ($this->commonUtil->isModuleEnabled('account')) {
            $accounts = \App\Utils\PerformanceUtil::getDropdownData('accounts', $business_id);
        }
