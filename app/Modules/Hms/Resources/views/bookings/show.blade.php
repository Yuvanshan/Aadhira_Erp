       ...
       <div class="col-md-8">
        <div class="box box-solid">
            <div class="box-header">
                ...
                <a class="tw-dw-btn tw-dw-btn-warning tw-text-white tw-dw-btn-sm pull-right" href="{{ action([\Modules\Hms\Http\Controllers\HmsBookingController::class, 'print'], [$transaction->id]) }}?format=a4" target="_blank" style="margin-left: 5px;">
                    <i class="fa fa-print"></i>
                    Print A4
                </a>
                <a class="tw-dw-btn tw-dw-btn-info tw-text-white tw-dw-btn-sm pull-right" href="{{ action([\Modules\Hms\Http\Controllers\HmsBookingController::class, 'print'], [$transaction->id]) }}?format=a5" target="_blank">
                    <i class="fa fa-print"></i>
                    Print A5
                </a>
            </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-right">
                            <strong class="room_price">@format_currency($transaction->room_price)</strong>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                        ...
                        <div class="col-xs-6 text-right">
                            <strong class="extra_price">@format_currency($transaction->extra_price)</strong>
                        </div>
                    </div>
                    <div class="row">
                    @php
                    ...
                    @if($discount_percent_disable == 0 && $transaction->discount_amount > 0)
                        ...
                        <div class="col-xs-6 text-right">
                        <strong class="total_discount">@format_currency($transaction->discount_amount * ( $transaction->extra_price + $transaction->room_price ) / 100)</strong>
                    @else
                    <div class="col-xs-6">
                            <strong>@lang('hms::lang.discount'):</strong>
                        </div>
                        <div class="col-xs-6 text-right">
                        <strong class="total_discount">@format_currency($transaction->discount_amount)</strong>
                    @endif
                        </div>
                    </div>
                    <div class="row">
                    <hr>
                        ...
                        <div class="col-xs-6 text-right">
                            <strong class="total">@format_currency($transaction->final_total)</strong>
                        </div>
                    </div>
                </div>
            </div>
