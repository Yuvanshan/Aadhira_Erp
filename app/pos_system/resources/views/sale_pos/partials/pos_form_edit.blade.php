<div class="row pos-toolbar-grid">
<div class="col-md-12 pos-edit-banner">
...
<div class="row pos-detail-grid">
	...
	@if(in_array('types_of_service', $enabled_modules) && auth()->user()->can('access_kitchen') && !empty($transaction->types_of_service))
		<div class="col-md-4 col-sm-6">
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon">
    ...
    @if((in_array('tables' ,$enabled_modules) || in_array('service_staff' ,$enabled_modules)) && auth()->user()->can('access_kitchen'))
    ...
    @endif
    @if(in_array('subscription', $enabled_modules) && auth()->user()->can('access_kitchen'))
		<div class="col-md-4 col-sm-6">
			<label>
...
@endif
<div class="row">
	<div class="col-sm-12 pos_product_div pos-order-table-wrap">
		...
		<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
			<thead>
				<tr>
					<th class="tex-center @if(!empty($pos_settings['inline_service_staff']) && auth()->user()->can('access_kitchen')) col-md-3 @else col-md-4 @endif">	
						@lang('sale.product') @show_tooltip(__('lang_v1.tooltip_sell_product_column'))
					</th>
					<th class="text-center col-md-3">
						@lang('sale.qty')
					</th>
					@if(!empty($pos_settings['inline_service_staff']) && auth()->user()->can('access_kitchen'))
