...
<div class="row pos-detail-grid">
	...
	@if(in_array('types_of_service', $enabled_modules) && auth()->user()->can('access_kitchen') && !empty($types_of_service))
		<div class="col-md-4 col-sm-6">
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon">
...
<div class="row">
	<div class="col-sm-12 pos_product_div pos-order-table-wrap">
		...
		<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
			<thead>
				<tr>
					<th class="tex-center tw-text-sm md:!tw-text-base tw-font-bold @if(!empty($pos_settings['inline_service_staff']) && auth()->user()->can('access_kitchen')) col-md-3 @else col-md-4 @endif">	
