		...
		@if(empty($receipt_details->letter_head))
			@if(!empty($receipt_details->logo))
				<div class="text-center">
					<img style="max-height: 120px; width: auto; display: block; margin: 0 auto;" src="{{$receipt_details->logo}}" class="img img-responsive">
				</div>
			@endif
...
<div class="row" style="color: #000000 !important;">
	...
	<div class="@if($receipt_details->show_barcode || $receipt_details->show_qr_code) col-xs-8 @else col-xs-12 @endif text-center">
