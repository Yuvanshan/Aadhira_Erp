...
@section('content')
    <div class="dashboard-shell">
        <div class="dashboard-hero">
            <div class="dashboard-hero__bg"></div>
            <div class="tw-px-5 tw-pt-4 tw-pb-6 lg:tw-px-6 lg:tw-pt-6">
                <div class="dashboard-hero__panel">
                    <div class="dashboard-hero__copy">
                        <span class="dashboard-hero__eyebrow">Business command center</span>
                        <h1 class="dashboard-hero__title">
                            {{ __('home.welcome_message', ['name' => Session::get('user.first_name')]) }}
                        </h1>
                        <p class="dashboard-hero__subtitle">
                            {{ \Carbon\Carbon::now()->format('l, d F Y') }}.
                            Track sales, cash flow, purchasing, and stock movement from one place.
                        </p>
                    </div>
                        ...
                        <div class="dashboard-hero__filters">
                            @if (count($all_locations) > 1)
                                <div class="dashboard-filter-card">
                                    <label class="dashboard-filter-card__label" for="dashboard_location">
                                        {{ __('business.business_locations') }}
                                    </label>
                                    {!! Form::select('dashboard_location', $all_locations, null, [
                                        'class' => 'form-control select2 dashboard-filter-card__input',
                            ...
                            <button type="button" id="dashboard_date_filter" class="dashboard-filter-button">
                ...
                @if (auth()->user()->can('dashboard.data') && $is_admin)
                    <div class="dashboard-kpi-grid dashboard-kpi-grid--primary">
                                ...
                                <div
                                    class="dashboard-stat-card dashboard-stat-card--hero tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl tw-ring-1 tw-ring-gray-200">
                                ...
                                <div
                                    class="dashboard-stat-card dashboard-stat-card--hero tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl hover:tw--translate-y-0.5 tw-ring-1 tw-ring-gray-200">
                                    <div class="tw-p-4 sm:tw-p-5">
                                        <div class="tw-flex tw-items-center tw-gap-4">
                                            <div
        ...
        @if (auth()->user()->can('dashboard.data') && $is_admin)
            <div class="tw-px-5 tw-isolate lg:tw-px-6">
                <div class="dashboard-kpi-grid dashboard-kpi-grid--secondary">
                            <div
                                class="dashboard-stat-card tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm tw-rounded-xl hover:tw-shadow-md hover:tw--translate-y-0.5 tw-ring-1 tw-ring-gray-200">
                                <div class="tw-p-4 sm:tw-p-5">
                                    <div class="tw-flex tw-items-center tw-gap-4">
                                        <div
        ...
        @if (!auth()->user()->can('dashboard.data'))
            <div class="tw-px-5 tw-pt-4 tw-pb-6 lg:tw-px-6">
                <div class="dashboard-empty-state">
                    <h2 class="dashboard-empty-state__title">{{ __('home.home') }}</h2>
                    <p class="dashboard-empty-state__text">
                        Your account does not currently have access to dashboard analytics. Use the navigation menu to continue working in the system.
                    </p>
                </div>
            </div>
        @endif
    ...
    <style>
        ...
        .dashboard-shell {
            background:
                ...
                linear-gradient(180deg, #f8fafc 0%, #eef2ff 18%, #f8fafc 46%, #f8fafc 100%);
            min-height: 100%;
        }
        ...
        .dashboard-hero__bg {
            ...
            inset: 0;
            background:
                radial-gradient(circle at 15% 20%, rgba(56, 189, 248, 0.22), transparent 18%),
                radial-gradient(circle at 85% 15%, rgba(255, 255, 255, 0.14), transparent 14%),
