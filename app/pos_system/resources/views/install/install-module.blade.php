              ...
              <form class="form" id="details_form" method="post" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="license_code" required class="form-control" id="license_code" value="{{ old('license_code', config('author.envato_purchase_code')) }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="login_username" required class="form-control" id="login_username" value="{{ old('login_username', auth()->user()->username ?? '') }}">
