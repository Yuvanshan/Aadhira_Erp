...
@section('title', __('eventmanagement::lang.add_decoration_order'))
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="mb-1">{{ __('eventmanagement::lang.add_decoration_order') }}</h4>
                    <p class="text-muted mb-0">{{ __('eventmanagement::lang.create_new_decoration_order') }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('eventmanagement.decoration-orders.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="decoration_type" id="decoration_type" class="form-control @error('decoration_type') is-invalid @enderror" required>
                                    ...
                                    @foreach($decorationTypes as $key => $value)
                                        <option value="{{ $key }}" {{ old('decoration_type') == $key ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="decoration_name" id="decoration_name" class="form-control @error('decoration_name') is-invalid @enderror"
                                       value="{{ old('decoration_name') }}" required>
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <p class="mb-2" id="summary-quantity">0</p>
                        </div>
                        <div class="col-6">
                            <small class="text-muted">{{ __('eventmanagement::lang.unit_price') }}</small>
                            <p class="mb-2" id="summary-unit-price">$0.00</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
            ...
            <div class="card shadow-sm mt-3">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0"><i class="fas fa-lightbulb mr-1"></i>{{ __('eventmanagement::lang.quick_tips') }}</h6>
                </div>
                <div class="card-body">
                    <ul class="list-unstyled mb-0 small">
                        <li class="mb-2"><i class="fas fa-check text-success mr-1"></i>{{ __('eventmanagement::lang.tip_select_event') }}</li>
                        <li class="mb-2"><i class="fas fa-check text-success mr-1"></i>{{ __('eventmanagement::lang.tip_choose_type') }}</li>
                        <li class="mb-2"><i class="fas fa-check text-success mr-1"></i>{{ __('eventmanagement::lang.tip_supplier_info') }}</li>
                        <li class="mb-0"><i class="fas fa-check text-success mr-1"></i>{{ __('eventmanagement::lang.tip_delivery_date') }}</li>
                    </ul>
                </div>
            </div>
        </div>
