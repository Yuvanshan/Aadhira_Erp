...
<section class="content">
    ...
    @component('components.widget', ['class' => 'box-primary'])
      ...
      <hr>
        ...
        @if(in_array('tables', $enabled_modules) || in_array('kitchen', $enabled_modules))
          <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-9">
              ...
              @if(in_array('kitchen', $enabled_modules))
                <div class="col-md-12">
                  <div class="checkbox">
                    <label>
                      {!! Form::checkbox('permissions[]', 'access_kitchen', in_array('access_kitchen', $role_permissions),
                      [ 'class' => 'input-icheck']); !!} Access Kitchen
                    </label>
                  </div>
                </div>
              @endif
