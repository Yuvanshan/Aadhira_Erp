        ...
        @component('components.widget', ['class' =>  'pos-tab-container'])
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu tw-rounded-lg">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-sm md:tw-text-base">@lang('lang_v1.backup_settings')</a>
                </div>
            </div>
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                ...
                @include('business.partials.settings_backup')
            </div>
        @endcomponent
        {{-- </div> --}}
        <!--  </pos-tab-container> -->
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on('change', '#business_backup_disk', function() {
            var val = $(this).val();
            if (val == 'dropbox') {
                $('div#business_dropbox_div').removeClass('hide');
                $('div#business_google_div').addClass('hide');
            } else if (val == 'google') {
                $('div#business_dropbox_div').addClass('hide');
                $('div#business_google_div').removeClass('hide');
            } else {
                $('div#business_dropbox_div').addClass('hide');
                $('div#business_google_div').addClass('hide');
            }
