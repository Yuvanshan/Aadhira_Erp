<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('desktop_client_mode', 'Desktop/Mobile ERP Client Mode:') !!}
                <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-desktop"></i>
                </span>
                {!! Form::select('desktop_client_mode', ['local' => 'Local / Offline Mode', 'cloud' => 'Cloud / Online Mode'], !empty($settings["desktop_client_mode"]) ? $settings["desktop_client_mode"] : 'cloud', ['class' => 'form-control select2', 'required']); !!}
                </div>
            </div>
        </div>
