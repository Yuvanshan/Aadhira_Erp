...
class SuperadminSettingsController extends Controller
{
    ...
    public function __construct(BusinessUtil $businessUtil)
    {
        ...
        $this->backupDisk = ['local' => 'Local', 'dropbox' => 'Dropbox', 'google' => 'Google Drive'];
    }
    ...
    public function edit()
    {
        ...
        $default_values = [
            ...
            'GOOGLE_DRIVE_FOLDER' => $is_demo ? null : env('GOOGLE_DRIVE_FOLDER'),
