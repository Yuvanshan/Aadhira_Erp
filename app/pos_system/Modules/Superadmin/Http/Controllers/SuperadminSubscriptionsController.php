...
class SuperadminSubscriptionsController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $business = \App\Business::findOrFail($input['business_id']);
            $settings = !empty($business->settings) ? json_decode($business->settings, true) : [];
            $settings['desktop_client_mode'] = $request->input('desktop_client_mode', 'cloud');
