        ...
        View::composer(
            ...
            function ($view) {
                if (isAppInstalled()) {
                    ...
                    $__system_settings = Cache::remember('layout_system_settings', 5, function () use ($keys) {
                        return System::getProperties($keys, true);
                    });

                    //Get js,css from modules
                    $module_additional_script = Cache::remember('layout_module_additional_script', 5, function () {
