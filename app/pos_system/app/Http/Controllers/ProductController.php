...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        $categories = \App\Utils\PerformanceUtil::getDropdownData('categories', $business_id);

        $brands = \App\Utils\PerformanceUtil::getDropdownData('brands', $business_id);

        $units = \App\Utils\PerformanceUtil::getDropdownData('units', $business_id);

        $tax_dropdown = TaxRate::forBusinessDropdown($business_id, false);
        $taxes = $tax_dropdown['tax_rates'];

        $business_locations = \App\Utils\PerformanceUtil::getDropdownData('locations', $business_id);
        $business_locations = collect($business_locations)->prepend(__('lang_v1.none'), 'none');
