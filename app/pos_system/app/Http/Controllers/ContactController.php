...
class ContactController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = \App\Utils\PerformanceUtil::getDropdownData('users', $business_id);

        $customer_groups = [];
        if ($type == 'customer') {
            $customer_groups = \App\Utils\PerformanceUtil::getDropdownData('customer_groups', $business_id);
        }
